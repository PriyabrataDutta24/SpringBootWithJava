...
public class UserController {
	...
	@ModelAttribute //run for all handler ->method for adding common data to response
...
//	current page = 0[page]
	...
	public String showContactDetail(Model m, @PathVariable("cId") Integer cId, Principal principal)
	{
...
//				update new pic
		...
		System.out.println("Conatct name "+contact.getcId());
			...
			Principal principal,HttpSession session)
	{
		...
		else
		{
			...
			return "redirect:/user/setting000000000000000000";
		}
